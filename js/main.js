// everytime you click a card, it changes to the person's image
// event listener for the clicking of each section
// function to 'turn over' on that specifc card (create array that holds two elements and contain the information of their class value)
// if the cards (two elements values) don't match, the cards should 'flip back over' (array erased) or revert to original rc pic (toggle back to hidden)
// if the cards do match, the cards should stay 'flipped' to the person's image (create new array or append to "new Array matched[]")
// use conditionals to compare class values (of each element) - if they are equal to each other, stay flipped (create new array or append to "new Array matched[]"), if not equal, revert back to RC picture (toggle back to hidden)
// at the end, erase/reset array 
//getAttribute() - to compare classes

// back card 1 of matching set
